...
{
    learnFromDemo(req.demo, req.k_gains, req.d_gains, req.num_bases, req.intersection_height, res.dmp_list);
...
{
    generatePlan(active_dmp_list, req.x_0, req.x_dot_0, req.t_0, req.goal, req.goal_tresh,
                 req.seg_length, req.tau, req.dt, req.integrate_iter, req.intersection_height, res.plan, res.at_goal);
    return true;
}
